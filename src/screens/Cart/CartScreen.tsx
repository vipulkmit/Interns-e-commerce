      ...
      <View style={styles.dataContainer}>
        ...
        <View style={styles.priceContainer}>
          ...
          <View style={[styles.quantityContainer, { backgroundColor: theme.background }]}>
            ...
            <SkeletonBox width={40} height={32} style={{ marginHorizontal: 2, borderRadius: 5 }} />
            <SkeletonBox width={30} height={32} style={{ borderRadius: 5 }} />
          </View>
        </View>
      </View>
...
const CartScreen = () => {
  ...
  const shouldShowSkeleton = isLoading && (!hasCheckedCart || cartData.length > 0);

  // Show empty cart only if we've checked cart and it's empty and not loading
  const shouldShowEmptyCart = hasCheckedCart && !isLoading && (!cartData || cartData.length === 0);
    ...
    return (
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        ...
        <>
          ...
          <View style={{ flexDirection: "row", paddingTop: 10 }}>
            <View style={styles.priceSubContainer}>
              <SkeletonBox width="100%" height={50} style={{ borderRadius: 10 }} />
            </View>
            <View>
              <SkeletonBox width={80} height={50} style={{ marginLeft: 8, borderRadius: 10 }} />
            </View>
          </View>
